...
class Routes(
  ...
  def documentation = List(
    ...
    ("""DELETE""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """receta/""" + "$" + """recipeId<[^/]+>/ingrediente/""" + "$" + """ingredientId<[^/]+>""", """controllers.IngredientController.quitIngredient(recipeId:String, ingredientId:String, quantityId:String, request:Request)"""),
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    case controllers_IngredientController_quitIngredient13_route(params@_) =>
      call(params.fromPath[String]("recipeId", None), params.fromPath[String]("ingredientId", None), params.fromQuery[String]("quantityId", None)) { (recipeId, ingredientId, quantityId) =>
